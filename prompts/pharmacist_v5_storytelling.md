...
- `taiwan_regulatory`: Aprobacion de INVIMA y estado de mercado en Colombia
...
| Estado de Mercado en Colombia | [Extraer de taiwan_regulatory.market_status] |
| Numero de Registros Sanitarios | [Extraer de taiwan_regulatory.total_licenses] |
...
**Reglas:**
- Listar hasta 5 registros sanitarios principales
...
| Numero de Registros Sanitarios | 8 |
...
De hecho, la combinacion S-1 ha sido aprobada en Japon y Colombia para el tratamiento del cancer colorrectal,
