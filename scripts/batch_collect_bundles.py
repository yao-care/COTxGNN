...
import pandas as pd
from cotxgnn.collectors import DrugBundleAggregator
from cotxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from cotxgnn.collectors.drug_bundle import PredictedIndication
    from cotxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from cotxgnn.collectors.drug_bundle import DrugBundle
