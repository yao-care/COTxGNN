...
BASE_URL = "https://cotxgnn.yao.care"
...
def generate_capability_statement() -> dict:
    ...
    return {
        ...
        "id": "cotxgnn-fhir-server",
        "url": f"{BASE_URL}/fhir/metadata",
        "version": "1.0.0",
        "name": "COTxGNNFHIRServer",
        "title": "COTxGNN FHIR Server - Colombia Drug Repurposing",
        "description": "FHIR R4 server for Colombia TxGNN drug repurposing predictions",
        "status": "active",
